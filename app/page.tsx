      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <p className="text-gray-200 hidden md:block">
            From dynamic gameplay mechanics to visually stunning environments, I
            specialize in building games that captivate players. Let’s create
